(function () {
  ...
  const exactMap = {
    ...
    'Вернуться на сайт': 'Сайтқа оралу',
    'Итого': 'Барлығы',
    'Итого:': 'Барлығы:',
    ...
    'Избранное': 'Таңдаулы',
    'Экспорт в PDF': 'PDF экспорттау',
    'Экспорт в Excel': 'Excel экспорттау',
    'фото': 'фото',
    'наименование': 'атауы',
    'артикул': 'артикул',
    'цена': 'баға',
    'ссылка на фото': 'фото сілтемесі',
    'Очистить': 'Тазарту',
    'Локальная демонстрация корзины для будущей посадки на Bitrix. В рабочей версии товары, остатки, оформление заказа и TipTopPay будут подключены через штатные механизмы Bitrix. Все цены отображаются в тенге.': 'Bitrix-ке көшіруге арналған себеттің жергілікті демо-нұсқасы. Жұмыс нұсқасында тауарлар, қалдықтар, тапсырысты рәсімдеу және TipTopPay Bitrix-тің штаттық механизмдері арқылы қосылады. Барлық бағалар теңгемен көрсетіледі.',
    'онлайн-оплата будет реализована через TipTopPay. На локальной копии кнопка оформления заказа пока не проводит платеж, чтобы не имитировать боевой процесс.': 'онлайн төлем TipTopPay арқылы іске қосылады. Жергілікті көшірмеде тапсырысты рәсімдеу түймесі әзірге төлем жүргізбейді.',
